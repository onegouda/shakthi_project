...
public class navigateClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigate_class);
        ...
        btnLoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String SourceLoc=source.getText().toString().trim();
                String DestinationLoc=destination.getText().toString().trim();

                //Check Condition
                if(SourceLoc.equals("") && DestinationLoc.equals("")){
                    //When Both value are blank
                    Toast.makeText(navigateClass.this, "Enter Both Location", Toast.LENGTH_SHORT).show();
                }else{
